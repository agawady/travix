...
public class ToughJetRequest {
	...
	public String toString() {
		return "ToughJetRequest [from=" + from + ", to=" + to
				+ ", outboundDate=" + outboundDate + ", inboundDate="
    ...
    public ToughJetRequest(String from, String to, String outboundDate,
    		String inboundDate, int numberOfAdults){
    	this.setFrom(from);
    	this.setTo(to);
    	this.setOutboundDate(outboundDate);
    	this.setInboundDate(inboundDate);

...
public class ToughJetResponse {
	...
	public String toString() {
		return "ToughJetResponse [carrier=" + carrier + ", basePrice="
				+ basePrice + ", tax=" + tax + ", discount=" + discount
	...
	public ToughJetResponse(String carrier, double basePrice, double tax, 
    		double discount, String departureAirportName, String arrivalAirportName, 
    ...
    public double getTotalPrice(){
    	double discountAmount = getBasePrice() * getDiscount();
    	return getBasePrice() + getTax() - discountAmount ;
    }
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((arrivalAirportName == null) ? 0 : arrivalAirportName
						.hashCode());
		long temp;
		...
		result = prime
				* result
				+ ((departureAirportName == null) ? 0 : departureAirportName
						.hashCode());
		temp = Double.doubleToLongBits(discount);
		result = prime * result + (int) (temp ^ (temp >>> 32));
		result = prime * result
				+ ((inboundDateTime == null) ? 0 : inboundDateTime.hashCode());
		result = prime
				* result
				+ ((outboundDateTime == null) ? 0 : outboundDateTime.hashCode());

...
public class CrazyAirResponse {
	...
	public String toString() {
		return "CrazyAirResponse [airline=" + airline + ", price=" + price
				+ ", cabinclass=" + cabinclass + ", departureAirportCode="
    ...
    public CrazyAirResponse(String airline, double price, String cabinclass, 
